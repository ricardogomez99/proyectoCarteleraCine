...
import com.trailers.demo.repositorio.PeliculaRepositorio;
...
public class HomeControlador {
    ...
    public ModelAndView verPaginaDeInicio(){
        List<Pelicula> ultimasPeliculas = peliculaRepositorio.findAll(PageRequest.of(0,4,Sort.by("fechaDeEstreno").descending())).toList();
    ...
    public ModelAndView listarPeliculas(@PageableDefault(sort = "fechaDeEstreno",direction = Sort.Direction.DESC)Pageable pageable){
